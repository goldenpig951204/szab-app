    ...
    <div className={`${styles.headerContainer} h-full`}>
      ...
      >
        ...
        >
          ...
          <Link href='/' style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fafafa', fontWeight: 700, fontSize: 26}}>
            <Image
      ...
      <div className={`relative flex`}>
        ...
        ></div>
        <div
          className={`${styles.menuWrapper} flex items-center justify-end relative w-full h-full`}
        >
          {wallet !== null && [
          ...
          {wallet === null && (
            ...
            >
              <h6 className={`${russo_one.className} text-white`}>{t("Sign In")}</h6>
            </div>
          )}
          {/* <div
