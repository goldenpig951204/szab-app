  ...
  return (
    <div className={`${styles.balanceContainer}`}>
      ...
      <div className='flex flex-row mt-3 justify-evenly'>
        <Button color={"Normal"} height={"Small"} radius={"Small"} textColor={"White"} fontSize={"Small"} width={"w-[100px]"} onClick={handleBuyZomfi}>{t("common.Buy $Zomfi")}</Button>
        <Button color={"Normal"} height={"Small"} radius={"Small"} textColor={"White"} fontSize={"Small"} width={"w-[100px]"} onClick={handleBuyZed}>{t("common.Buy $Zed")}</Button>
      </div>
    </div>
  )
}
